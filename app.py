...
from services.factura_tributaria import (
    FacturaTributariaService,
    FacturaTributariaException,
)
from services.xml_filter import XMLFilterService, XMLFilterException
...
if __name__ == "__main__":
    ...
    except (FacturaTributariaException, XMLFilterException):
